                        ...
                        protected void initChannel(Channel channel) throws Exception {
                            ...
                            channel.pipeline().addLast(new SimpleChannelInboundHandler<ByteBuf>() {
                                ...
                                public void channelActive(ChannelHandlerContext ctx) throws Exception {
                                    System.out.println("net.client connecting and writing...");
...
//                                    ctx.writeAndFlush(buf);
                                ...
                                protected void channelRead0(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf) throws Exception {
                                    System.out.println("net.client reading...");
                                    byte[] req = new byte[byteBuf.readableBytes()];
                                    byteBuf.readBytes(req);
                                    System.out.println(String.format("net.client read [%s]", new String(req, "utf-8")));
                                }
            ...
            System.out.println("net.client connect success.");
            channelFuture.channel().closeFuture().sync();
            System.out.println("net.client disconnect.");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
